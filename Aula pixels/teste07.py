...
# Exemplo de uso
caminho_imagem1 = "fototabletle.jpg"
caminho_imagem2 = "IN-7poco.jpg" #pocophone f1 = 12mpx
...
brilho_global1 = np.mean(np.log1p(imagem1)) 
brilho_global2 = np.mean(np.log1p(imagem2))
brilho_global3 = np.mean(np.log1p(imagem3))
...
"""
"""
def obter_numero(imagem): 
    largura, altura, _ = imagem.shape
    return largura * altura

k = obter_numero(imagem1)
print('k', k)
print('imagem1', imagem1.shape)
"""